...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 bg-gradient-hero opacity-60 animate-gradient" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Your AI-Powered{" "}
            <span className="text-gradient-primary">Creative Director</span>
          </motion.h1>
          ...
          >
            Generate professional, guideline-compliant retail creatives in seconds. 
          ...
          >
            {[
              ...
              { value: "<500KB", label: "Optimized Output" },
            ].map((stat, index) => (
